...
- Ricevere notifiche push geolocalizzate

## 3. Registrazione e account
- Devi avere almeno **14 anni**
- Devi fornire dati veritieri e aggiornati
- Sei responsabile della sicurezza della tua password
- Puoi cancellare l'account in qualsiasi momento

## 4. Contenuti dell'utente
Sei responsabile dei contenuti che pubblichi. Ti impegni a **non caricare**:
- Contenuti illeciti, diffamatori, violenti, sessuali o di odio
- Materiale coperto da copyright senza autorizzazione
...
### 5.1 Pagamenti
I pacchetti BOOST sono **acquisti una tantum** (no abbonamenti, no rinnovi automatici). I pagamenti sono gestiti da **Stripe Inc.**

### 5.2 Prezzi e durate
| Pacchetto | Durata | Prezzo |
|---|---|---|
| Settimana | 7 giorni | 4,99 € |
| Mese | 30 giorni | 14,99 € |
| 3 Mesi | 90 giorni | 29,99 € |
| 6 Mesi | 180 giorni | 49,99 € |
| 1 Anno | 365 giorni | 79,99 € |

I prezzi includono IVA dove applicabile.

### 5.3 Diritto di recesso (art. 52 Codice del Consumo)
Dato che il servizio BOOST è **immediatamente fruibile al completamento del pagamento** (messa in evidenza immediata), al momento dell'acquisto **rinunci esplicitamente al diritto di recesso di 14 giorni** ai sensi dell'art. 59 lett. a) del Codice del Consumo. Questa rinuncia è accettata cliccando "Procedi al pagamento".
...
## 6. Utilizzo corretto
Non puoi:
- Usare bot o sistemi automatici per creare account/contenuti
- Effettuare reverse engineering dell'app
- Tentare di bypassare sistemi di sicurezza
- Rivendere o redistribuire il Servizio
